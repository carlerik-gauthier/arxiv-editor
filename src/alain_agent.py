...
CONFIG = SpecialistConfig(
    ...
    category_descriptions={
        "math.AG": """Algebraic Geometry papers studying algebraic varieties, stacks, sheaves, schemes, moduli spaces, complex geometry, quantum cohomology. 
        ...
        "math.GR": "Group Theory papers covering fihnite groups, topological groups, representation theory, cohomology, classification and structure. Group theory studies the algebraic structures known as groups. The concept of a group is central to algebra.",
