"""Phase 6 Streamlit app to test JuliusAgent with ChrisAgent, AlainAgent, and MichelAgent."""
...
def run_app() -> None:
    """Render and run the Phase 6 multi-specialist chat interface.

    Returns:
        None: Renders the interface and updates session-state messages.
    """
    st.set_page_config(page_title="Phase 6 - JuliusAgent + AlainAgent", page_icon="🧮", layout="wide")
    st.title("Phase 6: JuliusAgent + ChrisAgent + AlainAgent + MichelAgent")
    ...
    with st.chat_message("assistant"):
        with st.spinner("JuliusAgent is allocating work across the specialists..."):
